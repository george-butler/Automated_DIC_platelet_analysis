...
This repository enables the morphology of indiviudal platelets to be quantified within a platelet spreading assay, for more information please read our [paper](https://www.nature.com/articles/s41598-022-08613-2). This work is an extension of the [Usiigaci](https://github.com/oist/Usiigaci) platform originally developed by Tsai *et al.* to track cell migration within phase contrast time-lapse microsopy. We have altered and retrained the mask regional convolutional neural network (Mask R-CNN) to segment the morphology of individual platelets from within Differential Inference Contrast (DIC) images. 
