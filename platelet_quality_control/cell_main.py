...
from cell_features import highlight_cells
...
def cell_tracking_clicked(param):
    ...
    with pg.BusyCursor():
        ...
        trj, col_tuple, col_weights = highlight_cells(path_in, merged_masks, min_cell_id=1)
        ...
        for cell_id in cell_ids:
            ...
            curr_cell_id_img = pg.TextItem(html='<div style="text-align: center"><b><span style="color: #{0:02x}{1:02x}{2:02x}; font-size: 6pt;">{3}</span></b></div>'.format(color[0], color[1], color[2], cell_id),
                anchor=(0, 0))
            ...
            curr_cell_id_mask = \
                pg.TextItem(html='<div style="text-align: center"><b><span style="color: #FFFFFF; font-size: 6pt;">{}</span></b></div>'.format(cell_id),
                            anchor=(0.5, 0.5))
...
b_cell_tracking = pg.QtGui.QPushButton("Colour\nMask")
